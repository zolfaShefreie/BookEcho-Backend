...
class ReqStatusChangeByProducerPermission(BasePermission):

    def has_object_permission(self, request, view, obj):
        return request.user == obj.podcast_producer


class ReqStatusChangeByApplicantPermission(BasePermission):
